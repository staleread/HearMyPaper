...
def upload_submission(
    ...
    try:
        ...
        encrypted = crypto.seal(content, public_key_bytes=public_key)
...
def download_submission(
    ...
    try:
        ...
        decrypted_content = crypto.unseal(
            encrypted_content, private_key_bytes=private_key_bytes
        )
...
def convert_submission_to_audio(
    ...
    try:
        ...
        audio_aes_key = crypto.unseal(
            audio_response.encrypted_audio_key, private_key_bytes=private_key_bytes
        )

        audio_bytes = crypto.decrypt_symmetric(
            audio_response.encrypted_audio, password=audio_aes_key
        )
